...
1. [Chapter 1: First Steps Into the Infinite]({{ site.baseurl }}/chapters/01-first-steps/)
2. [Chapter 2: The Emacs Philosophy (Or: Why Everything Is a Buffer)]({{ site.baseurl }}/chapters/02-philosophy/)
3. [Chapter 3: Movement and Key Bindings (Your Fingers Will Learn to Dance)]({{ site.baseurl }}/chapters/03-keybindings/)
4. [Chapter 4: Configuration Basics (Making Emacs Yours)]({{ site.baseurl }}/chapters/04-configuration/)
5. [Chapter 5: Package Management (Standing on Giants)]({{ site.baseurl }}/chapters/05-packages/)
6. [Chapter 6: Org-mode (Your Life in Plain Text)]({{ site.baseurl }}/chapters/06-org-mode/)
7. [Chapter 7: Emacs as an IDE (Who Needs Visual Studio?)]({{ site.baseurl }}/chapters/07-ide/)
8. [Chapter 8: Communication Hub (Never Leave Emacs Again)]({{ site.baseurl }}/chapters/08-communication/)
9. [Chapter 9: Just Enough Elisp (Programming Your Editor)]({{ site.baseurl }}/chapters/09-elisp/)
10. [Chapter 10: Dired - The Directory Editor]({{ site.baseurl }}/chapters/10-dired/)
11. [Chapter 11: Macros and Registers]({{ site.baseurl }}/chapters/11-macros-registers/)
12. [Appendix: Survival Guide for IDE Refugees]({{ site.baseurl }}/chapters/appendix-ide-refugees/)